...
static int8_t set_config(struct bmp5_osr_odr_press_config *osr_odr_press_cfg, struct bmp5_dev *dev)
{
    ...
    /* Structure to configure out-of-range pressure settings */
    ...
    if (rslt == BMP5_OK)
    {
        ...
        if (rslt == BMP5_OK)
        {
            ...
            printf("OSR ODR press configurations\n\n");
